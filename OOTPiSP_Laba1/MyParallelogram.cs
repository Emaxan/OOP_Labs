...
namespace OOTPiSP_Laba1 {
	...
	public class MyParallelogram : MyRombus {
		...
		public MyParallelogram(int x, int y, int length1, int length2, float angle, Color bgColor, Color borderColor,
		...
		public override string StdName { get; set; } = "Parallelogram";
